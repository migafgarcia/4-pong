...
//}
//
//int GameObject::check_collision(GameObject &other) {
//
...
//
//    double c_x_max = x_max < other_x_max ? x_max : other_x_max;
//    double c_x_min = x_min > other_x_min ? x_min : other_x_min;
//
//    double c_y_max = y_max < other_y_max ? y_max : other_x_max;
//    double c_y_min = y_min > other_y_min ? y_min : other_y_min;
//
//
